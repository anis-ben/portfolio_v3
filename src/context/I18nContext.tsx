...
const translations = {
  en: {
    ...
    heroIntro: "Hi, I am",
    heroTitle: "Anis",
    heroSubtitle: "Digital Product Designer & Developer",
    heroDesc: "Computer Science specialist bridging the gap between creative design and robust programming; designing thoughtful user interfaces and building them with the latest full-stack web technologies and a secure, fast backend.",
    ...
    contactEmailValue: "anusbenhamuda@gmail.com",
    contactPhoneValue: "+213 674 32 64 81",
    contactPhoneHref: "tel:+213674326481",
    contactLocationValue: "Algeria",
  ...
  ar: {
    ...
    heroIntro: "مرحبا انا",
    heroTitle: "أنيس",
    heroSubtitle: "مطور ومصمم منتجات رقمية",
    heroDesc: "متخصص في علوم الحاسب أعمل على سد الفجوة بين التصميم الإبداعي والبرمجة القوية؛ أصمم واجهات مستخدم مدروسة وأبنيها بأحدث تقنيات الويب المتكاملة مع بنية خلفية آمنة وسريعة",
